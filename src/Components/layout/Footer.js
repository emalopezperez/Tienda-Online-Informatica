        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center text-teal-600 dark:text-teal-300 sm:justify-start">
              <h1 className="text-3xl text-white">Hering</h1>
            </div>

            <p className="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-500 dark:text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quod
              aliquid explicabo consectetur asperiores id in molestiae optio
              eveniet illo officiis, minus rem quae nemo iste? A quam voluptate
              labore animi.
            </p>
