          ...
          <div className="lg:col-span-3 text-black">
            <div className="prose max-w-none">
              ...
              <p>
                ...
                est enim repellendus porro, aspernatur saepe asperiores
                exercitationem in ea ad rerum dicta. Lorem ipsum dolor sit amet
                consectetur adipisicing elit. Iste quidem impedit eum corrupti a
                sunt ipsam porro, excepturi vero est aliquam corporis adipisci
                dignissimos, quo deserunt iusto reiciendis dolores aliquid?
              </p>
            </div>
          </div>
        </div>
